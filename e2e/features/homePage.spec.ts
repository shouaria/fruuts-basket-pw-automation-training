...
Scenario.describe(
    ...
    () => {
        Scenario("[C12346] - User is able to see details for the fruit 'Exotic Pineapple'", async ({ steps }) => {
            ...
            await steps.THEN["I can see the <fruitName>'s name and details"]("Exotic Pineapple");
        });

        Scenario("[C12347] - User is able to see a 'Blueberry Burst' on the first page", async ({ steps }) => {
            await steps.GIVEN["I am on the Fruuts Basket home page"]();
